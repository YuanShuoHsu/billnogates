...
export const cartbarItemSlice = createSlice({
    ...
    reducers: {
        addToCartbarItem: (state, data) => {
            ...
            window.localStorage.setItem("CARTBAR_PRODUCTS", JSON.stringify(state.value))
        },
...
export const { addToCartbarItem, decrementCartbarItem, incrementCartbarItem, deleteCartbarItem } = cartbarItemSlice.actions
