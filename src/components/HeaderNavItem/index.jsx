        ...
        <Fragment>
            {
                item.layers === undefined ?
                    ...
                    <li onMouseEnter={handleEnterHover} onMouseLeave={handleLeaveHover} className={styles.HeaderNavItem} key={item.id}>
                        <div className={`${styles.link} ${headerNavSubMenu ? `${styles.active}` : ""}`}>
                            <span className={styles.text}>{item.nav}</span>
