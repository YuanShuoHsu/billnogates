...
export default function Pagination(props) {
        ...
        pageList.push(
            <SwiperSlide key={index}>
                <button
                    ...
                    className={`${styles.button} ${pagination === index + 1 ? `${styles.active}` : ""}`}>
    ...
    return (
        <div className={styles.Pagination}>
            <button onClick={handleFirstNumber} className={`${styles.navigation} ${pagination === 1 ? `${styles.active}` : ""}`}>
            ...
            <button onClick={handleLastNumber} className={`${styles.navigation} ${pagination === numberLength ? `${styles.active}` : ""}`}>
