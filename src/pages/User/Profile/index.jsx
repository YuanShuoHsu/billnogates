        ...
        <div className={styles.Profile}>
            {
                !userId ?
                    null :
                    <p className={styles.text}>用戶ID：{userId}</p>
            }
            {
                !userName ?
                    null :
                    <p className={styles.text}>用戶名稱：{userName}</p>
            }
            {
                !email ?
                    null :
                    <p className={styles.text}>郵子郵件：{email}</p>
            }
            {
                !phoneNumber ?
                    null :
            ...
            <button className={styles.button} onClick={handleSignOut}>登出</button>
        </div>
    )
}
