                ...
                !history ?
                    ...
                    history.length === 0 ?
                        ...
                        !history[sheetId - 1] ?
                            ...
                            <Fragment>
                                {
                                    history[sheetId - 1].information.pay !== "銀行轉帳" ?
                                        null :
                                                ...
                                                history[sheetId - 1].information.discount !== null ?
                                                    history[sheetId - 1].information.discount === 0 ?
                                                        ...
                                                        history[sheetId - 1].information.discount < 1 ?
                                                            <Fragment>
                                                                <span className={styles.text}>
                                                                    合計：NT${history[sheetId - 1].information.sum * history[sheetId - 1].information.discount + history[sheetId - 1].information.deliveryFee}
                                                                </span>
                                                                <span className={`${styles.text} ${styles.fee}`}>
                                                    ...
                                                    history[sheetId - 1].information.deliveryFee === 0 ?
                                                        ...
                                                        <Fragment>
                                                            <span className={styles.text}>
                                                                合計：NT${history[sheetId - 1].information.sum + history[sheetId - 1].information.deliveryFee}
                                                            </span>
                                                            <span className={`${styles.text} ${styles.fee}`}>
                                                                運費{history[sheetId - 1].information.deliveryFee}
                                                            </span>
