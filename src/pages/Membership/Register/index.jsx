...
import { signInWithEmailAndPassword, RecaptchaVerifier, signInWithPhoneNumber, updateProfile, signOut, createUserWithEmailAndPassword } from "firebase/auth";
        ...
        <form onSubmit={handleSubmit} className={styles.Register}>
            {
                !passwordIsShow ?
                    ...
                    <Fragment>
                        ...
                        <div className={styles.inputBox}>
                            <input onChange={event => handleSave(event, "passwordAgain")} value={passwordAgain} className={styles.input} type={inputTypeAgain} maxLength={30} required />
