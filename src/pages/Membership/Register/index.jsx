        ...
        <Fragment>
          <div className={styles.inputBox}>
            <input
              ...
              required
            />
            <span className={styles.inputText}>手機號碼</span>
          </div>
          {phoneNumberError && (
            <p className={styles.alert}>{phoneNumberError}</p>
          )}
          {OTPIsShow ? (
            <Fragment>
              <div className={styles.inputBox}>
                <input
                  ...
                  type="text"
                />
                <span className={styles.inputText}>驗證碼</span>
              </div>
              {OTPError && <p className={styles.alert}>{OTPError}</p>}
            </Fragment>
          ) : null}
        ...
        <Fragment>
          ...
          <div className={styles.inputBox}>
            <input
              ...
              required
            />
            <span className={styles.inputText}>確認密碼</span>
            {eyeIsShowAgain ? (
              <div className={styles.svgBox}>
                <svg
          ...
          {passwordAgainError && (
            <p className={styles.alert}>{passwordAgainError}</p>
          )}
          <button className={styles.button}>
            {!isLoading ? (
